 ...
 */
public class LIT extends AM1operation {

    public LIT(Heap heap, Stack stack, CommandPointer commandPointer, Pointer reference, Stack input, Stack output) {
    ...
    public void run(String arg) throws InvalidOperationArgumentException {
        ...
        this.stack.push(Integer.parseInt(arg));
        increment();
    }
}
